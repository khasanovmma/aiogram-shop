...
async def on_startup(dispatcher):
    ...
    categories_list = [('tvtexno', '📺📷🎥 Televizor, foto-video va audio'),
                       ('comp', '💻🖨🖥 Noutbuk, printer, kompyuterlar'),
                       ('phone', '📱⌚️ 🎧︎ Smartfon, telefon, gadjet, aksessuarlar'),
                       ('homeAppliances', 'Maishiy texnika')]
    await db.insert_category(categories_list)

    subcategory_list = [('tv', 'Televizorlar', 1), ('audio', 'Audio', 1), ('photo_video', 'Foto, video', 1),
    ...
    product_list = [('Samsung UE55AU9000UXCE',
                     ...
                     1, '9064000.00'), ('LG 50NANO796NF NanoCell 50" (2020)',
                        ...
                        7, '3549000.00'), ('Apple Iphone 13 Mini 512 GB Midnight',
                                           'https://olcha.uz/image/original/products/UsyqYtIa8OK5FR3JjsXaWcZ8wy0RsVpR9XXixqBYZ7snOBY1a15w2PKEJvNG.jpeg',
                                           'Apple Iphone 13 Mini 512 GB Midnight haqida tavsif', 7, '13541000.00'), (
                        ...
                        "Simsiz quloqchinlar Apple Airpods 3 umumiy ma'lumotlar", 8, '2675000.00'), (
